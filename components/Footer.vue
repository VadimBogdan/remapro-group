<template>
  <div id="footer">
    <ul>
      <li>
        <a id="facebook-icon" href @click.prevent
          ><svg
      ...
      <li>
        <a id="instagram-icon" href @click.prevent
          ><svg
            xmlns="http://www.w3.org/2000/svg"
            xmlns:serif="http://www.serif.com/"
            xmlns:xlink="http://www.w3.org/1999/xlink"
      ...
      <li>
        <a id="telegram-icon" href @click.prevent
          ><svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24">
            <title />
            <g id="Layer_2" data-name="Layer 2">
              <g id="Icon">
                <path
                  d="M12,0A12,12,0,1,0,24,12,12,12,0,0,0,12,0Zm3,19-3.88-3L18,4.44,9.48,14.52l-1.26,5h0V14.22L4,11,18,4.44Z"
                />
              </g>
            </g></svg
        ></a>
    ...
    <div id="creator">
      <span>Created By <a href="https://github.com/VadimBogdan">Vadim Bohdan</a> </span>
    </div>
  </div>
</template>
